...
class _UploadDocumentScreenState extends ConsumerState<UploadDocumentScreen> {
  ...
  Future<void> pickIssueDate(TextEditingController controller) async {
    final picked = await showDatePicker(
      context: context,
      initialDate: DateTime.now(),
      firstDate: DateTime(1950),
      lastDate: DateTime.now(), // ❌ future disable
    );
  ...
  Future<void> pickExpiryDate(TextEditingController controller) async {
    final picked = await showDatePicker(
      context: context,
      initialDate: DateTime.now(),
      firstDate: DateTime.now(), // ❌ past disable
          ...
          children: [
            ...
            CustomAnimatedTextField(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () => pickIssueDate(issueDateController),
              ),
            ...
            CustomAnimatedTextField(
              ...
              suffixIcon: IconButton(
                icon: const Icon(Icons.calendar_today),
                onPressed: () => pickExpiryDate(expiryDateController),
              ),
